...
**Status:** SHIPPED and iterating — all 4 phases done; live = v40, last snapshot Old Engine/40 (C-era ledger ≈ +148 over v31; v37/v38/v40 correctness releases, v39 = +8.86 Phase-2 NPS train; see the version table below). No candidate armed. **Started:** 2026-07-08 (baseline v30, ~90k NPS). **A/B TC:** 45+0.10 through v36, 50+0.20 from v37 campaigns.
