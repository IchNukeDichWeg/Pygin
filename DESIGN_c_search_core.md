...
| queued | P-47 check-extension budget raise (`set_check_ext_budget`, default 5 = v36 node-exact; candidate: 8 — deeper forced/perpetual check lines, motivated by the matetrack curve) | Runtime setter verified; extensions vein is thin per ledger (P-01 +6.8, P-43 +3.5 marginal) — tempered expectations | QUEUED for its own A/B slot after Q-01 (user request 2026-07-10) |
