...
**Status:** SHIPPED and iterating — all 4 phases done; live = v45-dev, last snapshot Old Engine/44 (C-era ledger ≈ +166 over v31; v37/v38/v40-v42 correctness releases, v39 = +8.86 NPS train, v43 = +5.18 verification removal, v44 = +13.31 TT prefetch — the biggest single NPS win in Elo terms; see the version table below). Armed candidate: FI-25 TT-value pruning-eval sharpener (v45-dev row below); FI-04 read +2.15 null, dormant. **Started:** 2026-07-08 (baseline v30, ~90k NPS). **A/B TC:** 45+0.10 through v36, 50+0.20 from v37 campaigns.
