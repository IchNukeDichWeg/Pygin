...
**Status:** SHIPPED and iterating — all 4 phases done; live = v46-dev, last snapshot Old Engine/45 (C-era ledger ≈ +180 over v31; v37/v38/v40-v42 correctness releases, v39 = +8.86 NPS train, v43 = +5.18 verification removal, v44 = +13.31 TT prefetch, v45 = +13.52 TT-value pruning-eval sharpener — back-to-back +13s; see the version table below). Armed candidate: TT_BITS=22 memory-size test (v46-dev row below); FI-06 read +2.26 null (dormant), FI-18 −1.25 null (dormant), FI-04 +2.15 null (dormant). **Started:** 2026-07-08 (baseline v30, ~90k NPS). **A/B TC:** 45+0.10 through v36, 50+0.20 from v37 campaigns.
