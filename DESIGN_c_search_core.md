...
**Status:** SHIPPED and iterating — all 4 phases done; live = v48-dev, last snapshot Old Engine/47 (C-era ledger ≈ +189 over v31; v44 +13.31, v45 +13.52, v46 +5.94 (96 MB TT), v47 +3.16 (192 MB TT) — memory-scaling vein now closed, diminishing; v47 also adds MultiPV node-exact; see the version table below). Armed candidate: none pinned — FI-23 history-driven quiet pruning REJECTED 2026-07-16 (twenty-first campaign, −5.23±7.1 @9,243 games, SPRT ACCEPT H0 stopped early — a real negative; HIST_PRUNE=0 dormant, do-not-retry; shallow-prune vein 0-for-2 with FI-18). FI-09 bundle NULL 2026-07-14 (twentieth campaign, +0.69±6.8, reverted, dormant) closed the time-policy vein alongside the soft_stop_frac 0.60 null. FI-30 qsearch TT-quality batch: **INCONCLUSIVE-POSITIVE, reverted to dormant** 2026-07-16 (twenty-second campaign, run as 10k + 5k pooled = 15,000 games: +4.84 ±5.55, pair ratio 1.09, pooled GSPRT[0,4] LLR +2.479 vs the +2.944 accept — the strongest dormant on the books; pre-registered rule applied, re-arm condition recorded in cengine.py: revisit after FI-29/FI-31 deepen the TT-quality stack, or at longer TC). Armed: none — next slot FI-29 (cuckoo upcoming-repetition, correctness-class). FI-06 +2.26, FI-18 −1.25, FI-04 +2.15 all null (dormant). **Started:** 2026-07-08 (baseline v30, ~90k NPS). **A/B TC:** 45+0.10 through v36, 50+0.20 from v37 campaigns.
...
| — | FI-30 qsearch TT-quality batch: `QS_TT_SHARPEN` (FI-25's bound rule at BOTH qsearch stand-pat sites, raw_stand split keeps the FI-03 cache exact) + `QS_KEEP_MOVE` (FB-22's keep-move rule for qs_tt_store move-0 stores); abi 11→12 | both off = v47 node-exact (pins); engagement 4/4 positions at d14 (−3.6%..+13.6% nodes), tactical spot-check + mate-guard clean | **INCONCLUSIVE-POSITIVE → DORMANT** 2026-07-16 (twenty-second campaign vs Old Engine/47, 10k + 5k pooled = 15k games): **+4.84 ±5.55** (50.70%, ptnml 440/1721/2979/1910/450, pair ratio 1.09, pooled GSPRT LLR **+2.479** < +2.944 accept) — strongest dormant on the books; reverted per the pre-registered no-third-tranche rule; re-arm after the TT-quality stack deepens (P-45 precedent) |
