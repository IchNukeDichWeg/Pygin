...
**Status:** SHIPPED and iterating — all 4 phases done; live = v48-dev, last snapshot Old Engine/47 (C-era ledger ≈ +189 over v31; v44 +13.31, v45 +13.52, v46 +5.94 (96 MB TT), v47 +3.16 (192 MB TT) — memory-scaling vein now closed, diminishing; v47 also adds MultiPV node-exact; see the version table below). Armed candidate: none pinned — FI-09 bundle (SINGLE_REPLY_INSTANT + EASY_MOVE) NULL 2026-07-14 (twentieth campaign, +0.69±6.8, reverted to False, dormant), closing the time-policy vein alongside the soft_stop_frac 0.60 null; next queue slot is FI-23 (history-driven quiet pruning). FI-06 +2.26, FI-18 −1.25, FI-04 +2.15 all null (dormant). **Started:** 2026-07-08 (baseline v30, ~90k NPS). **A/B TC:** 45+0.10 through v36, 50+0.20 from v37 campaigns.
