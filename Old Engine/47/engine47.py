"""
engine47.py -- FROZEN SNAPSHOT of v47 (2026-07-13).
===========================================================================

Snapshot of the repo-root ``cengine.py`` at the v47 milestone: v46 with the
transposition table at 23 bits (192 MB, from v46's 96 MB) + MultiPV support
(UCI spin 1..5, node-exact when off -- a C root-move exclusion list, abi 10).
The TT step is the 96->192 MB increment: A/B vs Old Engine/46 at the full
223-worker load **+3.16 +/-6.8 over 10,000 games @ 50+0.20** (50.46%%, ptnml
258/1211/2018/1208/305, pair ratio 1.03, normalized +6.54) -- net-positive
so DRAM bandwidth had not bitten, shipped on the same monotonic-low-risk
rule as v46. The diminishing +5.94 -> +3.16 closes memory-scaling (no 24).
TT_BITS=22 restores v46's 96 MB table; MultiPV defaults to 1 (byte-identical
to non-MultiPV play). Self-contained: the eval oracle / book provider is the
