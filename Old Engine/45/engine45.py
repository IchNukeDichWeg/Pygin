"""
engine45.py -- FROZEN SNAPSHOT of v45 (2026-07-12).
===========================================================================

Snapshot of the repo-root ``cengine.py`` at the v45 milestone: v44 + FI-25,
the TT-value pruning-eval sharpener (set_tt_eval_sharpen / TT_EVAL_SHARPEN
= True). The TT hit's SEARCH value replaces the raw static eval in RFP /
null-move / frontier-futility whenever its bound provably improves the
estimate (LOWER above / UPPER below / EXACT always; non-mate values, any
entry depth); static_eval itself stays RAW for the FI-03 TT eval cache and
the P-04 eval stack. A/B: **+13.52 +/-6.8 over 10,000 games @ 50+0.20 vs
Old Engine/44** (51.94%, ptnml 225/1100/2056/1299/320, pair ratio 1.22,
normalized +28.34). TT_EVAL_SHARPEN=False restores v44's search exactly.
