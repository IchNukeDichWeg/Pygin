"""
engine32.py -- FROZEN SNAPSHOT of v32 (2026-07-08).
===========================================================================

Snapshot of the repo-root ``cengine.py`` at the v32 milestone (v31 + P-03
Internal Iterative Reduction, A/B'd +7.30 +/-6.8 over 10k games vs v31),
made self-contained: the eval oracle / book provider is the sibling
``engine_eval.py`` (the same-day engine.py frozen), loaded by explicit
path -- a later retune of the live engine.py can never desync this
snapshot. C sources (csearch.c / eval_c.c / movegen.c) are frozen
