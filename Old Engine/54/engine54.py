"""
engine54.py -- FROZEN SNAPSHOT of v54 (2026-07-23).
===========================================================================

Snapshot of cengine.py at the v54 milestone. Like v53, NO C and NO code in
this file changed: v54 is the PST retune, 736 piece-square entries (735 moved)
fitted in engine.py by texel.py --pst, which this driver pushes into
csearch.so at construction. So the frozen engine_eval.py beside this file IS
the release. CONFIRMED vs Old Engine/53 on --nodes 1.75M: +31.20 +/-5.6 over
11,668 games (54.48%, ptnml 312/1142/2185/1579/616, GSPRT[0,2] LLR +7.806
ACCEPT) -- the second-largest release. Matetrack 928/775.
...
def _load_pyengine():
    ...
    live repo-root engine.py. v54 IS an engine.py change (the PST retune), so
    importing the live one would un-freeze this snapshot."""
    import importlib.util
    name = "_v54_engine_eval"
