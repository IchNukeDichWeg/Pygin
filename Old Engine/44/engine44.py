"""
engine44.py -- FROZEN SNAPSHOT of v44 (2026-07-12).
===========================================================================

Snapshot of the repo-root ``cengine.py`` at the v44 milestone: v43 + FI-26a,
the unconditional TT prefetch (``TT_PREFETCH(c.key)`` after apply_move at
the three child-recursion sites -- negamax, qsearch, root). NODE-IDENTICAL
by construction (a prefetch changes no value), so the CE_LADDER carries
over from v43 unchanged; the timed A/B priced the +4.9% NPS at
**+13.31 +/-6.8 over 10,000 games @ 50+0.20 vs Old Engine/43** (51.91%,
ptnml 250/1050/2073/1321/306, pair ratio 1.25, normalized +27.85) -- P-45's
original null INVERTED by FI-01's free child key. Self-contained: the eval
