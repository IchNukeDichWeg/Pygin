"""
engine48.py -- FROZEN SNAPSHOT of v48 (2026-07-16).
===========================================================================

Snapshot of the repo-root ``cengine.py`` at the v48 milestone: v47 + FI-30,
the qsearch TT-quality batch -- QS_TT_SHARPEN (FI-25's bound rule applied at
BOTH qsearch stand-pat sites: on a TT hit whose bound didn't cut, the
entry's SEARCH value replaces the static eval as the stand-pat wherever the
bound provably improves it; the raw_stand split keeps the FI-03 TT-eval
cache exact) + QS_KEEP_MOVE (FB-22's keep-move rule for qs_tt_store move-0
stores); abi 12. CONFIRMED vs Old Engine/47 over four pooled tranches =
**+4.73 +/-3.19 @ 21,605 games @ 50+0.20** (50.68%%, ptnml
606/2518/4309/2714/655, pair ratio 1.08, normalized +9.70), pooled
GSPRT[0,4] LLR **+3.475** past the +2.944 accept bound -- the C era's first
sequential-test ACCEPT. Both toggles False restore v47 node-exact.
