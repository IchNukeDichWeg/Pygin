"""
engine56.py -- FROZEN SNAPSHOT of v56 (2026-07-30).
===========================================================================

Snapshot of cengine.py at the v56 milestone. v56 = v55 + FI-107 ProbCut:
+4.11 +/- 4.2 over 21,806 games (--nodes 1.75M, GSPRT[0,4] LLR +2.971
ACCEPT), the fourth SPRT accept and the first pruning MECHANISM to pay after
the search lane was declared exhausted. Bench signature 1,145,629.

NNUE is deliberately NOT in this snapshot: FI-15 + FI-106 were confirmed at
+33.83 on a clock but the defaults were never armed, so v56 is HCE.
