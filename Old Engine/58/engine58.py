"""
engine58.py -- FROZEN SNAPSHOT of v58 (2026-08-03).
===========================================================================

Snapshot of cengine.py at the v58 milestone. v58 is the FIRST HCE/NNUE
HYBRID: USE_NNUE armed on nnue_v4_6f910e35bb1e.nnue, +19.11 +/- 7.8 over
3,404 games vs Old Engine/57 (TIMED 50+0.20, x86, GSPRT[0,4] LLR +2.950
ACCEPT H1). Bench signature 1,074,820.
...
class Engine:
    ...
    USE_NNUE = True
    # Resolved against _DIR (this snapshot's own folder), so it has to climb
    # back to the repo root -- the net is tracked once, not copied per
    # snapshot. Retiring the net into "NNUE/Old NNUE/" breaks this path, and
    # there is no silent HCE fallback: it raises.
