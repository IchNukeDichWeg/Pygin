"""
engine60.py -- FROZEN SNAPSHOT of v60 (2026-08-23).
===========================================================================

Snapshot of cengine.py at the v60 milestone. v60 RETRAINS THE NET ON REAL
GAMES (nnue_v12): the search is byte-identical to v59 and only NNUE_FILE
moves. 24,825,823 positions harvested from this project's own A/B match
logs, labelled at depth 12-16 by the search those games actually ran rather
than a 5,000-node budget, trained at LAMBDA 1.0 (search scores only -- the
logs predate the phantom-repetition fix and their result column is
draw-biased). vs Old Engine/59: GSPRT[0,4] LLR +2.957 ACCEPT at 793 pairs,
TIMED 50+0.5 x86. Bench signature 1,140,099.

The magnitude (+42.50 +/- 17.3) stopped at a bound and the ledger is NOT
advanced on it. Against v10 this net DREW over a full 10,000 games
(+3.75 +/- 6.8), so it ships as the point-estimate leader of two nets that
