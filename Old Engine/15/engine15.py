...
OPTIMIZATION CHANGELOG (2026-06-22 / 2026-06-23)
-------------------------------------------------
Implemented improvements #2-#7 from the optimization reference. #1 was
...
#7  LMR divisor 2.25 -> 2.0. The LMR table formula
    ...
    Outcome expected: fewer nodes at the same time budget, reaching deeper
    on average; risk is missing late-move refutations in tactical positions.
    A/B match (#6+#7 vs v14) run overnight 2026-06-23 will give the verdict.
"""
