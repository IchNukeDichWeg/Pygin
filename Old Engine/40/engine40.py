"""
engine40.py -- FROZEN SNAPSHOT of v40 (2026-07-11).
===========================================================================

Snapshot of the repo-root ``cengine.py`` at the v40 milestone: v39 + EP-01
FIDE-exact en-passant hashing -- the position key counts an ep square only
when a legal ep capture actually exists (= python-chess's
_transposition_key), so repetition detection agrees with the FIDE arbiter.
A/B vs Old Engine/39: **+4.31 +/-6.8 over 10,000 games @ 50+0.20** (50.62%,
ptnml 227/1203/2064/1231/275, pair ratio 1.05, normalized +9.14) -- a null
KEPT as correctness (PV-02/CB-01 precedent). Self-contained: the eval
