    ...
    int phase)
{
     ...
     */
    {
        ...
        if (SPACE_ON && PHASE_MAX > 0) {
            ...
            static const uint64_t SPACE_W = 0x0000000FFFFFF00ULL; /* ranks 1-3 */
            static const uint64_t SPACE_B = 0x00FFFFFF00000000ULL; /* ranks 4-6 */
    ...
    int square, uint64_t occupied)
{
    ...
    uint64_t diag = bishop_attacks(square, occupied);
    uint64_t line = rook_attacks(square, occupied);
    uint64_t attackers =
