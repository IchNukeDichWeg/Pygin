"""
engine59.py -- FROZEN SNAPSHOT of v59 (2026-08-10).
===========================================================================

Snapshot of cengine.py at the v59 milestone. v59 ARMS FI-106 LAZY NNUE
EVAL (LAZY_NNUE True): the net's forward pass is skipped wherever a cheap
bound already decides the node. Isolated toggle-only A/B vs Old Engine/58
(same v4 net both sides): GSPRT[0,4] LLR +2.950 ACCEPT at 2,264 pooled
pairs, TIMED 50+0.5 x86. Bench signature 1,214,534.
...
class Engine:
    ...
    USE_NNUE = True
    # Path climbs to the repo root -- shared tracked net, no copy here;
