"""
engine43.py -- FROZEN SNAPSHOT of v43 (2026-07-11).
===========================================================================

Snapshot of the repo-root ``cengine.py`` at the v43 milestone: v42 MINUS
CB-02's deep-null verification search (NV-01). The isolation A/B measured
the REMOVAL at **+5.18 +/-6.8 over 10,000 games @ 50+0.20 vs Old
Engine/42** (50.74%, ptnml 258/1151/2068/1230/293, pair ratio 1.08,
normalized +10.82); together with CB-02's own -2.88 lean this priced the
zugzwang-insurance re-searches at ~3-5 Elo of nodes-to-depth, so v43
drops them -- matching modern practice (Stockfish-family runs unverified
null; has_non_pawn + the TT cover zugzwang). NULL_VERIFY=True restores
v42's verifying search. Self-contained: the eval oracle / book provider
is the sibling ``engine_eval.py`` (the same-day engine.py frozen), loaded
by explicit path. C sources frozen alongside; ./setup.sh builds this
