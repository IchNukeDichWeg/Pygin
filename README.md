...
**≈ +148 Elo** of A/B-confirmed gains (v31 → v42: IIR, TT persistence, check
...
C-era ones are 10,000 games each; cumulative **≈ +148** over v31, and the
...
45 s + 0.10, v37–v42 at 50 s + 0.20), so Elo is comparable only within a
