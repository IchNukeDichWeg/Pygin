"""NNUE/shims/engine_nnue_m3.py -- seed 3 on gen5k_mix, for the variance screen.

Identical to every other net in this batch except `train.py --seed 3`:
...
gap BETWEEN corpora.
    ...
    python3 match.py NNUE/shims/engine_nnue_m3.py NNUE/shims/engine_nnue_v12.py \
...
Trained val 0.066145 at epoch 8 of 40. Val has been an inverted
...
class Engine(cengine.Engine):
    USE_NNUE = True
    NNUE_FILE = "NNUE/nets/nnue_m3_9e2ae31083c9.nnue"
