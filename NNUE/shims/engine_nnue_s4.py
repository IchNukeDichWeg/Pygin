"""NNUE/shims/engine_nnue_s4.py -- seed 4 on gen_only, for the variance screen.
...
gap BETWEEN corpora.
    ...
    python3 match.py NNUE/shims/engine_nnue_s4.py NNUE/shims/engine_nnue_v12.py \
...
Trained val 0.066822 at epoch 7 of 40. Val has been an inverted
...
class Engine(cengine.Engine):
    USE_NNUE = True
    NNUE_FILE = "NNUE/nets/nnue_s4_291b731ca0e5.nnue"
