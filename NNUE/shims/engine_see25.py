"""NNUE/shims/engine_see25.py -- FI-38 depth-scaled SEE pruning, captures half, K=25.
...
was unconfirmed when the audit was written.
    ...
    python3 match.py NNUE/shims/engine_see25.py cengine.py 5000 0 \
...
K=25 prunes a depth-6 SEE-losing capture below -150 cp.
"""
import cengine
