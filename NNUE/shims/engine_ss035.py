"""NNUE/shims/engine_ss035.py -- X-13: SOFT_STOP_STABLE_FRAC = 0.35 (HEAD ships 0.40).
...
only, a fixed-node run is blind to time policy.
    ...
    python3 match.py NNUE/shims/engine_ss035.py cengine.py 5000 0 \
