"""NNUE/shims/engine_nnue_m4.py -- seed 4 on gen5k_mix, for the variance screen.

Identical to every other net in this batch except `train.py --seed 4`:
...
gap BETWEEN corpora.
    ...
    python3 match.py NNUE/shims/engine_nnue_m4.py NNUE/shims/engine_nnue_v12.py \
...
Trained val 0.065946 at epoch 17 of 40. Val has been an inverted
...
class Engine(cengine.Engine):
    USE_NNUE = True
    NNUE_FILE = "NNUE/nets/nnue_m4_e80ba34329c6.nnue"
