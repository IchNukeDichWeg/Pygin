"""NNUE/shims/engine_nnue_s2.py -- seed 2 on gen_only, for the variance screen.
...
gap BETWEEN corpora.
    ...
    python3 match.py NNUE/shims/engine_nnue_s2.py NNUE/shims/engine_nnue_v12.py \
...
Trained val 0.066640 at epoch 16 of 40. Val has been an inverted
...
class Engine(cengine.Engine):
    USE_NNUE = True
    NNUE_FILE = "NNUE/nets/nnue_s2_7b40be3fccb8.nnue"
