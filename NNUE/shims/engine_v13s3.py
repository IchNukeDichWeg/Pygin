"""NNUE/shims/engine_v13s3.py -- v13 seed 3: the 105M 25,000-node corpus.

v61 exactly, with the net swapped. The ONLY variable is the net, so a gain
here is the corpus, not the search.

    python3 match.py NNUE/shims/engine_v13s3.py NNUE/shims/engine_v61b_deadtag.py \
...
Trained on this Mac, 8 epochs, cosine, --chunk 2000000, seed 3.
val 0.064127, quant MAE 10.84 cp. Val ranks NOTHING here -- it is
...
class Engine(cengine.Engine):
    USE_NNUE = True
    NNUE_FILE = "NNUE/nets/nnue_v13s3_e51bdefe18a2.nnue"
    LAZY_NNUE = True
