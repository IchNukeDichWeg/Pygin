"""NNUE/shims/engine_ssu070.py -- X-13: SOFT_STOP_UNSTABLE_FRAC = 0.70 (HEAD ships 0.80).
...
TIMED screen only, a fixed-node run is blind to time policy.
    ...
    python3 match.py NNUE/shims/engine_ssu070.py cengine.py 5000 0 \
