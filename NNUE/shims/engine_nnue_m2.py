"""NNUE/shims/engine_nnue_m2.py -- seed 2 on gen5k_mix, for the variance screen.

Identical to every other net in this batch except `train.py --seed 2`:
gen5k_mix, 40-epoch cosine, d2 16, lambda 0.75. v9's corpus -- the one that landed dead NULL.
...
gap BETWEEN corpora.
    ...
    python3 match.py NNUE/shims/engine_nnue_m2.py NNUE/shims/engine_nnue_v12.py \
...
Trained val 0.066068 at epoch 10 of 40. Val has been an inverted
...
class Engine(cengine.Engine):
    USE_NNUE = True
    NNUE_FILE = "NNUE/nets/nnue_m2_100bd8eb2a01.nnue"
