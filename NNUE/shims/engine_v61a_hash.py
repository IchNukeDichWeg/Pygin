...
A SHIP CANDIDATE, not an A/B control: this is v60 exactly, plus TT_BITS 20 (24 MB) in place of the default 23 (200 MB).
...
~1M-node searches) measured a 6 MB table at +11.2% NPS over 100 MB, faster in
...
should bleed exactly there. 20 rather than 18 is the hedge -- 24 MB keeps
...
class Engine(cengine.Engine):
    ...
    LAZY_NNUE = True
    TT_BITS = 20          # 24 MB at 24 B/entry (default is 23 = 200 MB)
