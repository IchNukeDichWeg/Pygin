"""NNUE/shims/engine_nnue_m1.py -- seed 1 on gen5k_mix, for the variance screen.
...
gap BETWEEN corpora.
    ...
    python3 match.py NNUE/shims/engine_nnue_m1.py NNUE/shims/engine_nnue_v12.py \
...
Trained val 0.065818 at epoch 14 of 40. Val has been an inverted
...
class Engine(cengine.Engine):
    USE_NNUE = True
    NNUE_FILE = "NNUE/nets/nnue_m1_a64388326c6f.nnue"
