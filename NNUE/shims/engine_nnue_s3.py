"""NNUE/shims/engine_nnue_s3.py -- seed 3 on gen_only, for the variance screen.
...
gap BETWEEN corpora.
    ...
    python3 match.py NNUE/shims/engine_nnue_s3.py NNUE/shims/engine_nnue_v12.py \
...
Trained val 0.066681 at epoch 7 of 40. Val has been an inverted
...
class Engine(cengine.Engine):
    USE_NNUE = True
    NNUE_FILE = "NNUE/nets/nnue_s3_fbe3eb939590.nnue"
