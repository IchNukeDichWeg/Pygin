"""NNUE/shims/engine_v13s2.py -- v13 seed 2: the 105M 25,000-node corpus.

v61 exactly, with the net swapped. The ONLY variable is the net, so a gain
here is the corpus, not the search.

    python3 match.py NNUE/shims/engine_v13s2.py NNUE/shims/engine_v61b_deadtag.py \
...
Trained on this Mac, 8 epochs, cosine, --chunk 2000000, seed 2.
val 0.064389, quant MAE 13.68 cp. Val ranks NOTHING here -- it is
...
class Engine(cengine.Engine):
    USE_NNUE = True
    NNUE_FILE = "NNUE/nets/nnue_v13s2_5f5dfeb02224.nnue"
    LAZY_NNUE = True
